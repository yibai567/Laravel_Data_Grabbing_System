                        ...
                        <div class="box-body" id="parent-form-area">
                          ...
                          @else
                            <div class='form-group header-group-0 ' id='form-group-name' style="">
                                ...
                                <div class="col-sm-10">
                                <input type='text' title="脚本名称" required  placeholder='请输入字母'  maxlength=70 class='form-control' name="name" id="name" value='{{$row[name]}}'/>
                            ...
                            <div class='form-group header-group-0 ' id='form-group-step' style="">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="step" required id="step" maxlength=5000 class='form-control' rows='5'>{{$row[step]}}</textarea>
                                <div class="text-danger"></div>
                                <p class='help-block'></p>
                                </div>
                            </div>
