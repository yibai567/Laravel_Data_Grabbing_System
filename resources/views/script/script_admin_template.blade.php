...
<body class="@php echo (Session::get('theme_color'))?:'skin-blue'; echo ' '; echo config('crudbooster.ADMIN_LAYOUT'); @endphp {{($sidebar_mode)?:''}} fixed">
<div id='app' class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section id='content_section' class="content col-md-8">
