        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body" style="padding:20px 0px 0px 0px">
                ...
                @endif
                        <div class="box-body" id="parent-form-area">
                          ...
                          @else
                            ...
                            <div class='form-group header-group-0 ' id='form-group-step' style="">
                                ...
                                <div class="col-sm-10">
                                    <div data-force="18" class="layer block" style="float: left;width: 40%;border: medium solid">
                        ...
                        <div data-force="30" class="layer block" style="position: absolute;right:20px; top:20px;width: 40%;border: medium solid">
                                        <ul id="foo" class="block__list block__list_words">
                                            @foreach($script_model as $value)
                                            <li>
                                                <div style="border: medium solid">
                                                    <label>模块id：<input type='hidden' name="script_model_id[]" value='{{$value->id}}'/>{{$value->id}}</label><br>
                                                    <label>模块名：{{$value->name}}</label><br>
                                                    <label>模块描述：{{$value->description}}</label><br>
                                                    <label>代码结构：{{$value->structure}}</label><br>
                                                    <label>参数规则：<input type='hidden' name="script_model_id[]" value='{{$value->parameters}}'/>{{$value->parameters}}</label><br>
                                                    <label><textarea name="script_model_params[]" maxlength=5000 class='form-control' rows='5'></textarea></label>
                                                </div>
                                            </li>
                                            @endforeach
                                        </ul>
