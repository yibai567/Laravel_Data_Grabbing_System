                ...
                <li>
                    ...
                    @foreach($value as $stepKey => $stepValue)
                        ...
                        @if ($parameters->type == 'string')
                            <span>
                                <input type="type" {{$requires}} name="script_model_params[{{$key}}][]" value="{{$stepValue}}">
                            </span>
                            <br>
                        @elseif ($parameters->type == 'json')
                            <span>
                            <textarea {{$requires}} name="script_model_params[{{$key}}][]" maxlength=5000 rows="3" cols="50">{{$stepValue}}</textarea>
                            </span>
                            <br>
                        @elseif ($parameters->type == 'boole')
                            @if ($parameters->default == 'true')
                            <span>
                                <input type="radio" checked name="script_model_params[{{$key}}][]" value="1"> true
                            </span>
                            <span></span>
                            <span>
                                <input type="radio" name="script_model_params[{{$key}}][]" value="2"> false
                            </span>
                            <br>
                            @else
                            <span>
                                <input type="radio" name="script_model_params[{{$key}}][]" value="1"> true
                            </span>
                            <span></span>
                            <span>
                                <input type="radio" checked name="script_model_params[{{$key}}][]" value="2"> false
                            </span>
                            <br>
                            @endif
                        @elseif ($parameters->type == 'text')
                            ...
                            <br>
                        @endif
                        <!-- <li class="connectedSortable ui-sortable" draggable="false" style>{!!$stepValue!!}</li> -->
                    @endforeach
                    </li>
                @endforeach
                </ul>
    ...
    <ul id="foo" class="block__list block__list_words" style="overflow-y: auto; overflow-x: hidden;">
        ...
        <li>
            ...
            @if ($parametersValue[type] == 'string')
                <span>
                    <input type="type" {{$requires}} name="script_model_params[{{$value->id}}][]" value="{{$parametersValue['default']}}">
                </span>
                <br>
            ...
            @if ($parametersValue['default'] == 'true')
                <span>
                    <input {{$requires}} type="radio" checked name="script_model_params[{{$value->id}}][]" value="1"> true
                </span>
            <span></span>
            <span>
                <input {{$requires}} type="radio" name="script_model_params[{{$value->id}}][]" value="2"> false
            </span>
            <br>
            @else
            <span>
                <input {{$requires}} type="radio" name="script_model_params[{{$value->id}}][]" value="1"> true
            </span>
            <span></span>
            <span>
                <input {{$requires}} type="radio" checked name="script_model_params[{{$value->id}}][]" value="2"> false
            </span>
            <br>
            @endif
