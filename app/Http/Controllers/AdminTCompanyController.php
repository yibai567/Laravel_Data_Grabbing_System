<?php namespace App\Http\Controllers;
	...
	class AdminTCompanyController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "cn_name";
			$this->limit = "20";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Cn Name','name'=>'cn_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'En Name','name'=>'en_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
