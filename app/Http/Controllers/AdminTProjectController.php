<?php namespace App\Http\Controllers;
	...
	class AdminTProjectController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string|max:70','width'=>'col-sm-10','placeholder'=>'请输入字母'];
			$this->form[] = ['label'=>'Discription','name'=>'discription','type'=>'textarea','validation'=>'nullable|max:255','width'=>'col-sm-10'];
