<?php namespace App\Http\Controllers;
	...
	class AdminTQueueInfoController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "t_queue_info";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"队列名","name"=>"name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'队列名','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:70','width'=>'col-sm-10','placeholder'=>'请输入字母'];
			$this->form[] = ['label'=>'队列描述','name'=>'description','type'=>'textarea','validation'=>'string|min:1|max:100','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'当前队列长度','name'=>'current_length','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form = [];
			//$this->form[] = ['label'=>'队列名','name'=>'name','type'=>'text','validation'=>'required|string|min:1|max:70','width'=>'col-sm-10','placeholder'=>'请输入字母'];
			//$this->form[] = ['label'=>'队列描述','name'=>'description','type'=>'textarea','validation'=>'required|string|min:1|max:100','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'当前队列长度','name'=>'current_length','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'数据库','name'=>'db','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'是否翻墙','name'=>'is_proxy','type'=>'radio','validation'=>'required|integer|between:1,2','width'=>'col-sm-10','dataenum'=>'1|需要;2|不需要'];
			//$this->form[] = ['label'=>'内容类型','name'=>'data_type','type'=>'radio','validation'=>'required|integer|between:1,2','width'=>'col-sm-10','dataenum'=>'1|html;2|json'];
			//$this->form[] = ['label'=>'队列类型','name'=>'type','type'=>'radio','validation'=>'required|integer|between:1,4','width'=>'col-sm-10','style'=>'1|html;2|json;3|capture;4-test'];
			//$this->form[] = ['label'=>'是否需要截图','name'=>'is_capture_image','type'=>'radio','validation'=>'required|integer|between:1,2','width'=>'col-sm-10','dataenum'=>'1|true;2|false'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
