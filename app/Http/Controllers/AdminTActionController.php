<?php namespace App\Http\Controllers;
	...
	class AdminTActionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'nullable|string|max:70','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Discription','name'=>'discription','type'=>'text','validation'=>'nullable|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Vhost','name'=>'vhost','type'=>'text','validation'=>'nullable|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Exchange','name'=>'exchange','type'=>'text','validation'=>'nullable|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Queue','name'=>'queue','type'=>'text','validation'=>'nullable|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Customer Path','name'=>'customer_path','type'=>'text','validation'=>'nullable|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Params','name'=>'params','type'=>'textarea','validation'=>'nullable|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Params","name"=>"params","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
